...
public class PlayerWeaponController : MonoBehaviour
{
    ...
    //This is the defualt speed from which our mass formula is derived.
    ...
    private void Start()
    {
        ...
        Invoke("EquipStartingWeapon", .1f); // Corrected method name
    }
    ...
    private void Shoot()
    {
        if (!WeaponReady() || !currentWeapon.CanShoot())
            return;
    ...
    private void FireSingleBullet()
    {
        ...
        rbNewBullet.velocity = currentWeapon.ApplySpread(BulletDirection()) * bulletSpeed;
    }
